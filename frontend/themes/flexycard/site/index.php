...
<div id="verticalTab">
    ...
    <ul class="resp-tabs-list">
        ...
        <li class="tabs-contact hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5a" data-tab-name="contact"
            style="margin-bottom: 48px !important;">
            ...
            <div class="row top-p">
                <div class="col-md-6 profile-l">
                    ...
                    <p style="margin-bottom:20px">
                        ...
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec nulla sagittis, scelerisque
                        mi vitae, congue turpis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec
                        nulla sagittis, scelerisque mi vitae, congue turpis.
                    </p>

                    <p style="margin-bottom:20px">
                        <i class="fa fa-quote-left"></i>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec nulla sagittis, scelerisque
                        mi vitae, congue turpis.
                ...
                <div class="col-md-6 profile-r">
                    ...
                    <div class="cycle-slideshow">
                        <img src="<?= $this->theme->baseUrl; ?>/images/img-profile/about_1.jpg" alt=""/>
                        <img src="<?= $this->theme->baseUrl; ?>/images/img-profile/about_2.png" alt=""/>
                        <img src="<?= $this->theme->baseUrl; ?>/images/img-profile/about_3.png" alt=""/>
                    </div>
                    ...
                    <div class="col-md-4 pack-service">
                        <div class="service">
                            ...
                            <div class="service-detail">
                                ...
                                <p>Fusce quis interdum ipsum.Suspendi suscipit vehicula sapienid mattis. Lorem ipsum
                                    amet consectetur.</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                                           class="collapse_tabs">
                                            ...
                                            <i class="glyphicon glyphicon-chevron-up"
                                               style="float: right;font-size: 13px;"></i>
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        <i class="fa fa-quote-left"></i> Anim pariatur cliche reprehenderit, enim
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="title_content" style="float: none;">
                        <div class="text_content">Programing Skills</div>
                        <div class="clear"></div>
                    </div>
                    <!-- /.title_content -->
                    ...
                    <div class="skills">
                        ...
                        <!-- .skillbar -->
                        <div class="skillbar clearfix" data-percent="80%">
                            <div class="skillbar-title"><span>Backbone.js</span></div>
                            <div class="skillbar-bar"></div>
                            <div class="skill-bar-percent">80%</div>
                        </div>
                        <!-- /.skillbar -->
                        ...
                        <div class="skillbar clearfix" data-percent="35%">
                            <div class="skillbar-title"><span>Java Android</span></div>
                            <div class="skillbar-bar"></div>
                    ...
                    <!-- .title_content -->
                    <div class="title_content" style="float: none;">
                        <div class="text_content">Server Administration Skills</div>
                        <div class="clear"></div>
                    </div>
                    <!-- /.title_content -->
                    ...
                    <div class="skills">
                        ...
                        <div class="skillbar clearfix" data-percent="85%">
                            <div class="skillbar-title"><span>Apache</span></div>
                            <div class="skillbar-bar"></div>
                        ...
                        <div class="skillbar clearfix" data-percent="95%">
                            <div class="skillbar-title"><span>Nginx</span></div>
                            <div class="skillbar-bar"></div>
                        ...
                        <!-- .skillbar -->
                        <div class="skillbar clearfix" data-percent="90%">
                            <div class="skillbar-title"><span>Debian Linux</span></div>
                            <div class="skillbar-bar"></div>
                            <div class="skill-bar-percent">90%</div>
                        </div>
                        <!-- /.skillbar -->
                ...
                <div class="col-md-6 resume-left">
                    ...
                    <ul class="attributes">
                        <li class="first">
                            <h5>Web Developer <span class="duration"><i
                                        class="fa fa-calendar color"></i> 2011 - 2013</span></h5>
                            <h6><span class="fa fa-briefcase"></span> Name of Company</h6>

                            <p>Lorem ipsum dolor sit amet, consectetur adipiscingVivamus sit amet ligula non lectus
                                cursus egestas. Cras erat lorem, fringilla quis sagittis in, sagittis inNam leo tortor
                                Nam leo tortor Vivamus.</p>
                        </li>
                        <li>
                            <h5>Front-End Developer <span class="duration"><i class="fa fa-calendar color"></i> 2010 - 2011</span>
                            </h5>
                            <h6><span class="fa fa-briefcase"></span> Name of Company</h6>
                    ...
                    <ul class="attributes">
                        <li class="first">
                            <h5>Master of Engineering <span class="duration"><i class="fa fa-calendar color"></i> 2011 - 2013</span>
                            </h5>
                        ...
                        <li>
                            <h5>Bachelor of Engineering <span class="duration"><i class="fa fa-calendar color"></i> 2010 - 2011</span>
                            </h5>
                            <h6><span class="fa fa-book"></span> Name of University</h6>
                    ...
                    <ul class="attributes">
                        <li class="first">
                            <h5>Graphic &amp; Art Direction <span class="duration"><i class="fa fa-calendar color"></i> 2013 - 2014</span>
                            </h5>
                            <h6><span class="fa fa-trophy"></span> Name of Institute</h6>

                            <p>Emi Phasellus congue auctor risuspon, eget males. Pellentes que un imperdiet, odio quis
                                orn sollicitud. Sed vitae lectus elementum mauris.</p>
                        </li>
                        <li>
                            <h5>Design &amp; Art Direction <span class="duration"><i class="fa fa-calendar color"></i> 2012 - 2013</span>
                            </h5>
                            <h6><span class="fa fa-trophy"></span> Name of Institute</h6>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="reference clearfix">
                        ...
                        <ul>
                            <li class="clearfix">
                                <img src="http://placehold.it/100x100" class="img_reference" width="100" height="100"
                                     alt="">

                                <p>“Many desktop publishing packages and web page editors now use Lorem Ipsum as their
                                    default will model text, and a search for 'lorem ipsum' hope is uncover many web
                                    sites still”</p>
                            ...
                            <li class="clearfix">
                                ...
                                <p>“very nice colleague she always helped me out if i didnt know something editors now
                                    use Lorem Ipsum as their default”</p>
                            ...
                            <li class="clearfix">
                                ...
                                <p>“old colleague and now close friend, she is really sweet and helpfull packages and
                                    web page editors now use Lorem Ipsum as their default will model text”</p>
                ...
                <div id="portfoliolist">
                    ...
                    <div class="portfolio logo" data-cat="logo">
                        ...
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/1.jpg" rel="portfolio"
                               title="Lorem ipsum dolor sit amet, consectetur adipiscing Vivamus sit amet ligula non lectus.consectetur adipiscingVivamus sit amet">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/1.jpg"
                                     alt="Visual Infography"/>
                    ...
                    <div class="portfolio catWeb" data-cat="catWeb">
                        ...
                        <div class="portfolio-wrapper">
                            <a href="http://www.youtube.com/watch?v=c9MnSeYYtYY" rel="portfolio">
                                ...
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/2.jpg"
                                     alt="Visual Infography"/>
                    ...
                    <div class="portfolio catWeb" data-cat="catWeb">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/3.jpg" rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/3.jpg" alt="Sonor's Design"/>
                    ...
                    <div class="portfolio catMotion" data-cat="catMotion">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/4.jpg" rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/4.jpg"
                                     alt="Typography Company"/>
                    ...
                    <div class="portfolio catWeb" data-cat="catWeb">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/5.jpg"
                               title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien."
                               rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/5.jpg" alt="Weatherette"/>
                    ...
                    <div class="portfolio catMotion" data-cat="catMotion">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/6.jpg" rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/6.jpg" alt="BMF"/>
                    ...
                    <div class="portfolio catGraphic" data-cat="catGraphic">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/7.jpg"
                               title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien."
                               rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/7.jpg" alt="Techlion"/>
                    ...
                    <div class="portfolio logo" data-cat="logo">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/8.jpg" rel="portfolio"
                               title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien.">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/8.jpg" alt="KittyPic"/>
                    ...
                    <div class="portfolio catWeb" data-cat="catWeb">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/9.jpg"
                               title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien."
                               rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/9.jpg" alt="Graph Plotting"/>
                    ...
                    <div class="portfolio catGraphic" data-cat="catGraphic">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/10.jpg" rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/10.jpg"
                                     alt="QR Quick Response"/>
                    ...
                    <div class="portfolio logo" data-cat="logo">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/11.jpg"
                               title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien."
                               rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/11.jpg" alt="Mobi Sock"/>
                    ...
                    <div class="portfolio logo" data-cat="logo">
                        <!-- .portfolio-wrapper -->
                        <div class="portfolio-wrapper">
                            <a href="<?= $this->theme->baseUrl; ?>/images/portfolio/12.jpg" rel="portfolio">
                                <img src="<?= $this->theme->baseUrl; ?>/images/portfolio/12.jpg"
                                     alt="Village Community Church"/>
                                                    ...
                                                    <div id="carousel-1" class="carousel slide" data-ride="carousel">
                                                        ...
                                                        <div class="carousel-inner">
                                                            ...
                                                            <div class="item active">
                                                                <img
                                                                    src="<?= $this->theme->baseUrl; ?>/images/blog/blog-1.jpg"
                                                                    alt=""/>
                                                            ...
                                                            <div class="item">
                                                                <img
                                                                    src="<?= $this->theme->baseUrl; ?>/images/blog/blog-2.jpg"
                                                                    alt=""/>
                                                            ...
                                                            <div class="item">
                                                                <img
                                                                    src="<?= $this->theme->baseUrl; ?>/images/blog/blog-3.jpg"
                                                                    alt=""/>
                                                        ...
                                                        <a class="right carousel-control" href="#carousel-1"
                                                           data-slide="next">
                                        ...
                                        <div class="col-md-12 post_content">
                                            <div class="content post_format_standart">
                                                <div class="top_c ">
                                                    ...
                                                    <div class="title_content">
                                                        <div class="text_content"><a href="#post-1" class="read_more">Blog
                                                                Post Gallery</a></div>
                                                        <div class="clear"></div>
                                                    </div>
                                                    ...
                                                    <ul class="info">
                                                        ...
                                                        <li><i class="glyphicon glyphicon-time"></i> January 31, 2014
                                                        </li>
                                                        <li><i class="glyphicon glyphicon-user"></i> by Jane Doe</li>
                                                        <li><i class="glyphicon glyphicon-tag"></i> jquery, slider, web
                                                            design
                                                        </li>
                                                    </ul>

                                                    <div class="blog-content">
                                                        <p><i class="fa fa-quote-left"></i> Lorem ipsum dolor sit amet,
                                                            ...
                                                            vel, aliquet nec, vulputate eget, arcu. In enim justo...</p>
                                                    </div>
                                                </div>
                                            </div>

                                            <a href="#post-1" class="read_m pull-right">Read More <i
                                        ...
                                        <div class="col-md-12 post_content">
                                            <div class="content post_format_standart">
                                                <div class="top_c ">
                                                    ...
                                                    <div class="title_content">
                                                        <div class="text_content"><a href="#post-2" class="read_more">Blog
                                                                Aside post</a></div>
                                                        <div class="clear"></div>
                                                    </div>
                                            ...
                                            <a href="#post-2" class="read_m pull-right">Read More <i
                                                    class='glyphicon glyphicon-chevron-right'></i></a>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 post_media">
                                            ...
                                            <div class="media">
                                                <div class="he-wrap tpl2">
                                                    <img src="<?= $this->theme->baseUrl; ?>/images/blog/blog-4.jpg"
                                                         class="img-hover" alt=""/>
                                                </div>
                                        ...
                                        <div class="col-md-12 post_content">
                                            <div class="content post_format_standart">
                                                <div class="top_c ">
                                                    ...
                                                    <div class="title_content">
                                                        <div class="text_content"><a href="#post-3" class="read_more">Blog
                                                                Post Image</a></div>
                                                        <div class="clear"></div>
                                                    </div>
                                            ...
                                            <a href="#post-3" class="read_m pull-right">Read More <i
                                                    class='glyphicon glyphicon-chevron-right'></i></a>
                            ...
                            <div class="row inner">
                                ...
                                <div class="col-md-12"
                                    ...
                                    <article class="postPage">
                                        ...
                                        <p class="caps">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        ...
                                        <div class="col-md-12 first">
                                            ...
                                            <div class="post_comments">
                                                ...
                                                <div class="comments">
                                                    ...
                                                    <div class="comment">
                                                        ...
                                                        <div class="text">
                                                            <div class="name">John Doe <a class="reply"
                                                                                          href="#">Reply</a></div>
                                                        ...
                                                        <div class="comment sub">
                                                            ...
                                                            <div class="text">
                                                                <div class="name">Bill Gates <a class="reply" href="#">Reply</a>
                                                                </div>
                                                                <div class="date">12, September, 2013</div>
                                                                Lorem ipsum dolor sit amet, consectetur
                                                                adipiscing elit. Praesent condimentum sed elit
                                                    ...
                                                    <div class="comment">
                                                        ...
                                                        <div class="text">
                                                            <div class="name">John Smith <a class="reply"
                                                                                            href="#">Reply</a></div>
                                                            <div class="date">12, September, 2013</div>
                                                            Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit. Praesent condimentum sed elit
                                                    ...
                                                    <div class="comment">
                                                        ...
                                                        <div class="text">
                                                            <div class="name">Andrian Robert <a class="reply" href="#">Reply</a>
                                                            </div>
                                                            <div class="date">12, September, 2013</div>
                                                            Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit. Praesent condimentum sed elit
                                                ...
                                                <div class="comment_form">
                                                    ...
                                                    <form method="post" id="comment_form">
                                                        ...
                                                        <button class="submit" data-toggle="modal"
                                                                data-target=".bs-example-modal-sm">Post Comment
                                                        </button>
                                                    </form>
                                                    <div class="clear"></div>
                                            ...
                                            <div class="col-md-12" style="margin-top: 20px;">
                                                <a href="#post-2" class="readmore" id="pagination"><i
                                                        class="glyphicon glyphicon-chevron-right"></i></a>
                                                <a href="#" class="readmore disabled" id="pagination"><i
                                                        class="glyphicon glyphicon-chevron-left"></i></a>
                                                <a href="#blog" class="readmore"><i
                                                        class="glyphicon glyphicon-chevron-left"></i> All Posts</a>
                                            </div>
                                ...
                                <div class="col-md-12"
                                    ...
                                    <article class="postPage">
                                        ...
                                        <div class="col-md-12 first">
                                            ...
                                            <div class="col-md-12" style="margin-top: 20px;">
                                                <a href="#post-3" class="readmore" id="pagination"><i
                                                        class="glyphicon glyphicon-chevron-right"></i></a>
                                                <a href="#post-1" class="readmore" id="pagination"><i
                                                        class="glyphicon glyphicon-chevron-left"></i></a>
                                                <a href="#blog" class="readmore"><i
                                                        class="glyphicon glyphicon-chevron-left"></i> All Posts</a>
                                            </div>
                                ...
                                <div class="col-md-12"
                                    ...
                                    <article class="postPage">
                                        ...
                                        <div class="col-md-12 post_media">
                                            ...
                                            <div class="media">
                                                <div class="he-wrap tpl2">
                                                    <img src="<?= $this->theme->baseUrl; ?>/images/blog/blog-2.jpg"
                                                         class="img-hover" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-12 first">
                                            ...
                                            <div class="col-md-12" style="margin-top: 20px;">
                                                ...
                                                <a href="#post-2" class="readmore" id="pagination"><i
                                                        class="glyphicon glyphicon-chevron-left"></i></a>
                                                <a href="#blog" id="blog" class="readmore"><i
                                                        class="glyphicon glyphicon-chevron-left"></i> All Posts</a>
                                            </div>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h3 class="modal-title h3_modal" style="color: #fff !important;">FlexyVcard -
                                        Responsive Vcard Template</h3>
                                </div>
                                <div class="modal-body">
                                    <p>FlexyVcard is an impressive and professional online vcard, a beautiful portfolio
                                        with sliding effect, resume and contact information with Google map.</p>

                                    <p>It’s simple! Just download and install in a few minutes, you can show your online
                                        card to your friend, customer or employer in an interview by phone or tablet.
                                        Because FlexyVcard is a responsive template, you can view your website on pc as
                                        well as handheld devices. You can also link to your social profiles, display
                                        your portfolio in many media format such as image, youtube video, flash...</p>
                                </div>
                        ...
                        <div class="col-md-5">
                            <div class="contact-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <span class="span-info"><i class="glyphicon glyphicon-envelope"></i> Email:</span>
                                        ramin.farmani@gmail.com
                                    </li>
                                    <li><span class="span-info"><i class="glyphicon glyphicon-phone"></i> Phone:</span>
                                        +98 915 302 3386
                                    </li>
                                    <li><span class="span-info"><i class="glyphicon glyphicon-globe"></i> Website:</span>
                                        www.ramilix.com
                                    </li>
                                    <li><span class="span-info"><i class="glyphicon glyphicon-comment"></i> Skype:</span>
                                        ramin.farmani
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="contact-form">
                                ...
                                <form action="#" id="contactform">
                                    <p class="form-group" id="contact-name">
                                        <label for="name">Your Name</label>
                                        <input type="text" name="name" class="form-control name-contact"
                                               id="inputSuccess" placeholder="Name..."/>
                                    </p>

                                    <p class="form-group" id="contact-email">
                                        <label for="email">Your Email</label>
                                        <input type="text" name="email" class="form-control email-contact"
                                               id="inputSuccess" placeholder="Email..."/>
                                    </p>

                                    <p class="form-group" id="contact-message">
                                        <label for="message">Your Message</label>
                                        <textarea name="message" cols="88" rows="6" class="form-control message-contact"
                                                  id="inputError" placeholder="Message..."></textarea>
                                    </p>
                                    <input type="reset" name="reset" value="CLEAR" class="reset">
                                    <!-- <input type="submit" name="submit" value="SEND MESSAGE" class="submit">-->

                                    <section class="button-demo" style="display: inline-block;">
                                        <button class="ladda-button submit send_email" name="submit" data-color="green"
